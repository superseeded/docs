...
The SDM (Species Distribution Modeling) endpoints allow you to generate predictive models showing where species can survive under current and future climate conditions. The API uses MaxEnt modeling with CHELSA climate data to produce high-quality distribution maps.
...
<ParamField body="scenario" type="string" default="ssp585">
  ...
  Options:
  - `ssp126` - Very low emissions (best case)
...
<Accordion title="Technical Architecture">
  ...
  - **Modal.com** for scalable compute (16GB RAM per job)

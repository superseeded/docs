...
<ResponseField name="routes" type="array" required>
  ...
  <Expandable title="Route object properties">
    <ResponseField name="id" type="string" required>
      Unique route identifier (e.g., `resolve-specs-from-upload`)
    </ResponseField>
    ...
    <ResponseField name="endpoint" type="string" required>
      Full API endpoint path (e.g., `/v1/resolve/specs/from-upload`)
    </ResponseField>
  ...
  "routes": [
    {
      ...
      "endpoint": "/v1/resolve/specs/from-upload",
      "method": "POST",
      "requires_auth": true,

...
This endpoint returns metadata about the 13 sources available to `/v1/verify/plant-names`: 12 authoritative data sources, including the versioned APC/APNI backbone, plus review-only Gemini suggestions.
...
<ResponseField name="sources" type="object[]">
  ...
  <Expandable title="Source Object">
    ...
    <ResponseField name="backbone_version" type="string">
      Version of a fixed taxonomic backbone used to produce reproducible results. Currently returned for APC/APNI.
    </ResponseField>
...
```json
{
  "sources": [
    {
      "id": "apc_apni",
      "name": "Australian Plant Census / APNI",
      "description": "Versioned APC accepted names, synonyms and APNI fallback",
...
| Source | Weight | Role |
|--------|--------|------|
| APC/APNI | 1.00 | Australian accepted names, synonyms and nomenclature |
...
- **Pinned release**: APC/APNI follows the declared backbone version (`2026-03-25`)

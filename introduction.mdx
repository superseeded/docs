...
We provide an API that aligns unstructured nursery stock labels into standardized, structured profiles. This engine allows you to match supply and demand based on biological reality rather than text strings.

## Core Capabilities

<CardGroup cols={1}>
<Card title="Spec Alignment" icon="wand-magic-sparkles" href="/guides/alignment">

...
1. Download the plugin from the [releases page](https://github.com/superseeded/wordpress-plugin/releases)
...
The complete plugin source is available for download:

<Card title="Download Plugin" icon="download" href="https://github.com/superseeded/wordpress-plugin/releases">

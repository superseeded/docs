...
short-lived JWT tokens for your merchants' frontend upload widgets.
...
3. Pass the JWT token to your frontend.
4. Your frontend uses this token to authenticate direct uploads to our upload service.

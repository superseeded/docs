...
After a successful upload, call the validate-pot-sizes endpoint with the delegation token and file URL to process the file and retrieve enriched data.

<CodeGroup>

```javascript validate-pot-sizes.js

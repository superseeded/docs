...
The SuperSeeded Embed Script provides a complete, ready-to-use upload widget that you can add to your platform with minimal code. It handles the entire upload flow including the UI, TUS resumable uploads, and event callbacks.
...
<CardGroup cols={2}>
  ...
  <Card title="Resumable Uploads" icon="rotate">
    Built-in TUS support for reliable large file uploads
  </Card>
